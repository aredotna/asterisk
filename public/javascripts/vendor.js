...
PushAway = (function(_super) {

  __extends(PushAway, _super);

  function PushAway(useMass, callback) {
    this.useMass = useMass != null ? useMass : true;
    this.callback = callback != null ? callback : null;
    this.pool = [];
    this._delta = new Vector();
    PushAway.__super__.constructor.apply(this, arguments);
  }

  PushAway.prototype.apply = function(p, dt, index) {
    var dist, rsq, distSq, i, mt, o, overlap, r1, r2, radii, _i, _ref, _results;
    _results = [];
    for (i = _i = index, _ref = this.pool.length - 1; index <= _ref ? _i <= _ref : _i >= _ref; i = index <= _ref ? ++_i : --_i) {
      o = this.pool[i];
      if (o !== p) {
        ...
        rsq = radii * radii * 6;
        if (distSq <= rsq) {
          this._delta.norm().scale(1.0 - distSq / rsq);
          p.acc.add(this._delta.scale(1));
          _results.push(typeof this.callback === "function" ? this.callback(p, o, overlap) : void 0);
        } else {
          _results.push(void 0);
        }
